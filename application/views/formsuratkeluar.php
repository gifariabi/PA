  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('index.php/Admin/index') ?>">
        ...
        <div class="sidebar-brand-text mx-3">ISOMA<sup>2019</sup></div>
      </a>
...
<table>
	<tr>
		<td>Nomor Surat</td> 
		<td>:</td>
		<td><input type="text" name="no_suratkeluar" class="form-control form-control-user"></td>
	</tr>
	<tr>
		<td>Penerima</td> 
		<td>:</td>
		<td><input type="text" name="penerima"class="form-control form-control-user"></td>
	</tr>
	<tr>
