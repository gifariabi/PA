      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
           ...
           <!-- Topbar Search -->
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="<?php echo site_url('Organisasi/searchOrganisasi');?>" method="post">
...
<div class="table-responsive">
    <table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" >
        ...
        <tr>
            ...
            <td><a href="<?= base_url().'/Organisasi/editOrg/'.$data->idOrganisasi;?>" class="btn btn-primary">Edit</a></td>
            <td><a href="<?= base_url().'/Organisasi/hapus_Org/'.$data->idOrganisasi;?>" onclick="return confirm('Anda Yakin Menghapus Organisasi ?')" class="btn btn-danger">Hapus</a></td>
        </tr>
        <?php $i++; }?>
    </table>
