      ...
      <li class="nav-item">
        ...
        <div id="collapseFive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('index.php/Surat/suratkeluar/'.$this->session->idOrganisasi.'/'.$this->session->userdata('nim')); ?>" style="text-decoration: none">Buat Surat</a>
            </a>
          </div>
        </div>
      </li>
