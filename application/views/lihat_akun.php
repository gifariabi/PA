...
<table>
  ...
  <table>
        <tr>
            <td><a href="<?= base_url().'/Organisasi/edit_akun/'.$nim;?>" class="btn btn-primary btn-block">Edit Data</a></td><td>&nbsp;</td>
            <td><a href="<?= base_url().'/Edit_foto/editf/'.$nim;?>" class="btn btn-success btn-user btn-block">Edit Foto</a></td><td>&nbsp; </td>
            <td><a href="<?= base_url().'/Organisasi/hapus_akun/'.$nim.'/'.$this->session->userdata('idOrganisasi');?>" onclick="return confirm('Anda Yakin Menghapus Akun ?')"  class="btn btn-danger btn-block">Hapus</a></td>
        </tr> 
</table>
  </div>
  </div>
