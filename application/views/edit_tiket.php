...
<form class="user" action="<?php echo base_url().'index.php/tiket/update';?>" method="post">
    <center>
    ...
    <input type="hidden" name="no_tiket" value="<?php echo $key->no_tiket; ?>">
      <input type="text" name="nama" class="form-control form-control-sm" placeholder="Nama Lengkap" value="<?php echo $key->nama; ?>">
    </div>
    <div class="form-group">
      <input type="text" name="nim" class="form-control form-control-sm" placeholder="NIM" value=<?php echo $key->nim; ?>>
    </div>
    
    <div class=form-group>
      <input type="text" name="jurusan" class="form-control form-control-sm" placeholder="Jurusan" value="<?php echo $key->jurusan; ?>">
    </div>
    <div class=form-group>
      <input type="email" name="email" class="form-control form-control-sm" placeholder="Email" value="<?php echo $key->email; ?>">
    </div>
    <div class=form-group>
      <select name="jumlah"  class="form-control form-control-sm" >
						<option value ="<?php echo $key->jumlah; ?>">- - - Pilih Jumlah Tiket - - -</option>
    ...
    <div class=form-group>
      <select name="metode"  class="custom-select custom-select-sm form-control - form-control-sm" >
						<option value="<?php echo $key->metode_pembayaran; ?>">- - - Pilih Metode - - -</option>
