  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('index.php/Admin/index') ?>">
        ...
        <div class="sidebar-brand-text mx-3"> <?= $this->session->namaLengkap ?><sup></sup></div>
      </a>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Himpunan Mahasiswa D3 Sistem Informasi</h6>
                ...
                <div class="text">
                  <div class="text">
                    Himpunan Mahasiswa D3 Sistem Informasi (HMDSI) adalah wadah untuk penyaluran bakat buat KEMA SI untuk menyalurkan potensi-potensi yang ada pada diri kita. Selain potensi dalam akademik, HMDSI juga tempat belajar bagaimana mengasah potensi non-akademik yang ada pada diri kita.
                  </div>
                </div>
              </div>
            </div>
